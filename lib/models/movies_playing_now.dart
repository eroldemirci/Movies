...
//
//     final moviesNowPlaying = moviesNowPlayingFromJson(jsonString);

import 'dart:convert';

MoviesNowPlaying moviesNowPlayingFromJson(String str) =>
    MoviesNowPlaying.fromJson(json.decode(str));

String moviesNowPlayingToJson(MoviesNowPlaying data) =>
